...
############change############
path_img_train = './D_OUHANDS_size_64/x_img_train.npy'
path_label_train = './D_OUHANDS_size_64/y_label_train.npy'
path_img_test = './D_OUHANDS_size_64/x_img_test.npy'
path_label_test = './D_OUHANDS_size_64/y_label_test.npy'
...
#####################################################################
some_more_layers = nn.Sequential(nn.Conv2d(256, 11, kernel_size=1, padding=1, bias=False),
                                 nn.BatchNorm2d(11), 
                                 nn.ReLU(inplace=True),
                                 ) 
                                 
model.feature = nn.Sequential(*list(model.feature)[:-3],some_more_layers)


for name, param in model.named_parameters():
    if str(name)==str('feature.0.BasicConv.0.weight') or str(name)==str('feature.0.channel_attention.fc.0.weight') or str(name)==str('feature.0.channel_attention.fc.2.weight') or str(name)==str('feature.0.Conv_1x1.0.weight') or str(name)==str('feature.1.weight') or str(name)==str('feature.4.weight') or str(name)==str('feature.8.weight') or str(name)==str('feature.11.weight'):
